...
console.log(addArtist(artists,'Abas Kamara', '1992-2022', 'Web Design', 'African American', 'I have a background in construction. I am attending BloomTech to become a Frontend Developer'));
...
function artistByCountry(artists, string){
  const spanishArtists = [];
  for(let i = 0; i < artists.length; i++){
    if(artists[i].nationality === string){
